extension UCF.Selector {
    @frozen public struct Path: Equatable, Hashable, Sendable {
        ...
        @inlinable public init(components: [String] = [], fold: Int = 0, seal: Seal? = nil) {
...
extension UCF.Selector.Path {
    @inlinable public var hasTrailingParentheses: Bool {
        self.seal != nil
    }

    @inlinable public var visible: ArraySlice<String> {
        self.components[self.fold...]
    }
}
extension UCF.Selector.Path {
    mutating func append(_ component: UCF.Selector.PathComponent) {
