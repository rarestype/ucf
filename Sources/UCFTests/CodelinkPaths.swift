...
@Suite struct CodelinkPaths: ParsingSuite {
    typealias Format = UCF.Selector

    @Test static func DotDot() throws {
    ...
    @Test static func SlashDot() throws {
        let link: UCF.Selector = try Self.roundtrip("Unicode/Scalar.value")
        #expect(link.base == .relative)
        #expect(link.path.components == ["Unicode", "Scalar", "value"])
    ...
    @Test static func DotSlash() throws {
        let link: UCF.Selector = try Self.roundtrip("Unicode.Scalar/value")
        #expect(link.base == .relative)
        #expect(link.path.components == ["Unicode", "Scalar", "value"])
    ...
    @Test static func SlashSlash() throws {
        let link: UCF.Selector = try Self.roundtrip("Unicode/Scalar/value")
        #expect(link.base == .relative)
        #expect(link.path.components == ["Unicode", "Scalar", "value"])
        #expect(link.path.visible == ["value"])
    ...
    @Test static func SingleCharacter() throws {
    ...
    @Test static func EmptyTrailingParentheses() throws {
    ...
    @Test static func EmptyTrailingComponent() throws {
        let link: UCF.Selector = try Self.roundtrip("Real.init/")
        #expect(link.base == .relative)
        #expect(link.path.components == ["Real", "init"])
        #expect(link.path.visible == ["Real", "init"])
    ...
    @Test static func DivisionOperator() throws {
    ...
    @Test static func CustomOperator() throws {
        let link: UCF.Selector = try Self.roundtrip("/-/(_:_:)")
        #expect(link.base == .relative)
        #expect(link.path.components == ["/-/(_:_:)"])
        #expect(link.path.visible == ["/-/(_:_:)"])
    ...
    @Test static func ClosedRangeOperator() throws {
        let link: UCF.Selector = try Self.roundtrip("...(_:_:)")
        #expect(link.base == .relative)
        #expect(link.path.components == ["...(_:_:)"])
        #expect(link.path.visible == ["...(_:_:)"])
