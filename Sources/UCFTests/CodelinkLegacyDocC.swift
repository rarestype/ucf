...
@Suite struct CodelinkLegacyDocC: ParsingSuite {
    typealias Format = UCF.Selector

    @Test static func Slashes() throws {
    ...
    @Test static func Filter() throws {
    ...
    @Test static func FilterInterior() throws {
    ...
    @Test static func FilterLegacy() throws {
    ...
    @Test static func FilterAndHash() throws {
    ...
    @Test static func HashMinus() throws {
    ...
    @Test static func HashSlingingSlasher() throws {
        let link: UCF.Selector = try Self.roundtrip("Sloth//(_:)-4ko57")
        let hash: FNV24 = .init("4ko57", radix: 36)!
    ...
    @Test static func PatternWithArguments1() throws {
    ...
    @Test static func PatternWithArguments2() throws {
    ...
    @Test static func PatternWithArguments3() throws {
    ...
    @Test static func PatternReturnsTuple1() throws {
    ...
    @Test static func PatternReturnsTuple2() throws {
    ...
    @Test static func PatternReturnsTuple3() throws {
    ...
    @Test static func PatternReturnsTuple4() throws {
    ...
    @Test static func PatternReturnsVoid() throws {
    ...
    @Test static func PatternReturnsDouble() throws {
    ...
    @Test static func PatternReturnsWildcard() throws {
        let link: UCF.Selector = try Self.roundtrip("Sloth/update(_:)->_")
    ...
    @Test static func PatternReturnsWildcardParenthesized() throws {
        let link: UCF.Selector = try Self.roundtrip("Sloth/update(_:)->(_)")
    ...
    @Test static func PatternReturnsDoubleParenthesized() throws {
        let link: UCF.Selector = try Self.roundtrip("Sloth/update(_:)->(Double)")
    ...
    @Test static func PatternFullSignature1() throws {
    ...
    @Test static func PatternFullSignature2() throws {
    ...
    @Test static func PatternComplexSignature1() throws {
    ...
    @Test static func PatternComplexSignature2() throws {
        let link: UCF.Selector = try Self.roundtrip("f(_:)-((Int?))->(Int?)")

        #expect(link.path.components == ["f(_:)"])
        #expect(link.suffix == .signature(.function(["Int?"], ["Int?"])))
    }
    @Test static func PatternComplexSignature3() throws {
        let link: UCF.Selector = try Self.roundtrip("f(_:)-([(Int?)].Type)->[Int?].Type")

        #expect(link.path.components == ["f(_:)"])
        #expect(link.suffix == .signature(.function(["[Int?].Type"], ["[Int?].Type"])))
    }
    @Test static func PatternComplexSignature4() throws {
        let link: UCF.Selector = try Self.roundtrip(
            "f(_:)-([[T]:Set<T>],[T])->[[Int?]??:`A B`]"
        )

        #expect(link.path.components == ["f(_:)"])
        #expect(
            link.suffix == .signature(
                .function(
                    ["[[T]:Set<T>]", "[T]"],
                    ["[[Int?]??:`A B`]"]
                )
