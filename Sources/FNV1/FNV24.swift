@frozen public struct FNV24: Equatable, Hashable, Sendable {
...
extension FNV24: Comparable {
    @inlinable public static func < (a: FNV24, b: FNV24) -> Bool { a.value < b.value }
}
extension FNV24: RawRepresentable {
    ...
    @inlinable public var rawValue: Int32 { .init(self.value) }
...
extension FNV24 {
    @inlinable public init?(_ string: Substring, radix: Int = 36) {
    ...
    @inlinable public init(truncating extended: Extended) {
        self.init(value: extended.value >> 8)
    }

    @inlinable public init(folding fnv32: FNV32) {
...
extension FNV24 {
    @inlinable public var min: Extended {
        .init(value: self.value << 8)
    }
    @inlinable public var max: Extended {
