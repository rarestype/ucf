...
extension FNV32: RawRepresentable {
    ...
    @inlinable public var rawValue: Int32 { .init(bitPattern: self.value) }
}
extension FNV32 {
...
extension FNV32 {
    @inlinable public var folded: FNV24.Extended {
        let fold: UInt32 = self.value >> 24
        return .init(value: (self.value ^ fold) << 8 | fold)
    }

    @inlinable public static func recover(from folded: FNV24.Extended) -> Self {
