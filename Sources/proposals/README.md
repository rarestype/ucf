...
This module defines the example symbols used in the various proposals and articles. It does not contain the UCF implementation, which lives in the [unidoc](https://github.com/rarestype/unidoc) repository.
